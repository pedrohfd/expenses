    ...
    <Container>
      ...
      <ScrollView>
        <ContentArea>
          ...
          <Content>
            A sua privacidade é importante para nós. É política do Expense
            respeitar a sua privacidade em relação a qualquer informação sua que
            possamos coletar no site Expense , e outros sites que possuímos e
            ...
            quando exigido por lei.{'\n\n'}O nosso site pode ter links para
            sites externos que não são operados por nós. Esteja ciente de que
            ...
            alguns dos serviços desejados.{'\n\n'}O uso continuado de nosso site
          ...
          <Content>
            ...
            informação que o Expense oferece no site e com caráter enunciativo,
            ...
            racista, xenofóbica, jogos de hoje ou azar, qualquer tipo de
            pornografia ilegal, de apologia ao terrorismo ou contra os direitos
            humanos;
            {'\n\n'}C{')'} Não causar danos aos sistemas físicos (hardwares) e
            lógicos (softwares) do Expense, de seus fornecedores ou terceiros,
          ...
          <Content>
            ...
            é efetiva a partir de October/2021.
          </Content>

          <Title>Termos</Title>

          <Content>
            Ao acessar ao site Expense, concorda em cumprir estes termos de
          ...
          <Title>Uso de Licença</Title>

          <Content>
            É concedida permissão para baixar temporariamente uma cópia dos
            materiais (informações ou software) no site Expense , apenas para
            ...
            no site Expense;{'\n\n'}4. remover quaisquer direitos autorais ou
            outras notações de propriedade dos materiais; ou{'\n\n'}5.
            transferir os materiais para outra pessoa ou 'espelhe' os materiais
            em qualquer outro servidor.{'\n\n'}Esta licença será automaticamente
            rescindida se você violar alguma dessas restrições e poderá ser
            rescindida por Expense a qualquer momento. Ao encerrar a
          ...
          <Content>
            1. Os materiais no site da Expense são fornecidos 'como estão'.
            Expense não oferece garantias, expressas ou implícitas, e, por este
            ...
            Expense não garante ou faz qualquer representação relativa à
          ...
          <Content>
            Em nenhum caso o Expense ou seus fornecedores serão responsáveis por
            ...
            da incapacidade de usar os materiais em Expense, mesmo que Expense
            ou um representante autorizado da Expense tenha sido notificado
          ...
          <Title>Precisão dos materiais</Title>

          <Content>
            Os materiais exibidos no site da Expense podem incluir erros
            técnicos, tipográficos ou fotográficos. Expense não garante que
            qualquer material em seu site seja preciso, completo ou atual.
            Expense pode fazer alterações nos materiais contidos em seu site a
            qualquer momento, sem aviso prévio. No entanto, Expense não se
          ...
          <Content>
            O Expense não analisou todos os sites vinculados ao seu site e não é
            responsável pelo conteúdo de nenhum site vinculado. A inclusão de
            qualquer link não implica endosso por Expense do site. O uso de
          ...
          <Content>
            O Expense pode revisar estes termos de serviço do site a qualquer
          ...
          <Content>
            ...
            as leis do Expense e você se submete irrevogavelmente à jurisdição
